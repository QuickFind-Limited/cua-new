...
test('recorded flow - codegen-1755470514813', async ({ page }) => {
  ...
  // To view the trace: npx playwright show-trace codegen-1755470514813-trace.zip
 ...
 * Generated on: 2025-08-17T22:42:17.051Z
 * Session ID: codegen-1755470514813
 * Start URL: https://www.google.com/
 * End URL: https://www.zoho.com/us/inventory/signup/
 * Duration: 22s
 * 
 * To replay this test:
 * npx playwright test codegen-1755470514813-recording.spec.ts
 * 
 * To view the trace:
 * npx playwright show-trace recordings/codegen-1755470514813-trace.zip
 * 
