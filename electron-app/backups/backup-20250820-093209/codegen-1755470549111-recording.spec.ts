...
test('recorded flow - codegen-1755470549111', async ({ page }) => {
  ...
  // To view the trace: npx playwright show-trace codegen-1755470549111-trace.zip
  ...
  await expect(page).toHaveURL(/https://www\.zoho\.com/us/inventory/signup//);
 ...
 * Generated on: 2025-08-17T22:42:57.144Z
 * Session ID: codegen-1755470549111
 * Start URL: https://www.zoho.com/us/inventory/logout/
 * End URL: https://www.zoho.com/us/inventory/signup/
 * Duration: 28s
 * 
 * To replay this test:
 * npx playwright test codegen-1755470549111-recording.spec.ts
 * 
 * To view the trace:
 * npx playwright show-trace recordings/codegen-1755470549111-trace.zip
 * 
