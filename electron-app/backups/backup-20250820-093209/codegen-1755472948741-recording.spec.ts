...
test('recorded flow - codegen-1755472948741', async ({ page }) => {
  ...
  // To view the trace: npx playwright show-trace codegen-1755472948741-trace.zip
  ...
  await expect(page).toHaveURL(/https://www\.zoho\.com/us/inventory/logout//);
 ...
 * Generated on: 2025-08-17T23:22:42.832Z
 * Session ID: codegen-1755472948741
 * Start URL: https://www.zoho.com/us/inventory/logout/
 * End URL: https://www.zoho.com/us/inventory/logout/
 * Duration: 14s
 * 
 * To replay this test:
 * npx playwright test codegen-1755472948741-recording.spec.ts
 * 
 * To view the trace:
 * npx playwright show-trace recordings/codegen-1755472948741-trace.zip
 * 
