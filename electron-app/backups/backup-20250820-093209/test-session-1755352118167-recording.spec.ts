 ...
 * Generated on: 2025-08-16T13:48:42.647Z
 * Session ID: test-session-1755352118167
 * Start URL: https://example.com
 * End URL: https://example.com/
 * Duration: 4s
 * 
 * To replay this test:
 * npx playwright test test-session-1755352118167-recording.spec.ts
 * 
 * To view the trace:
 * npx playwright show-trace recordings/test-session-1755352118167-trace.zip
 * 
