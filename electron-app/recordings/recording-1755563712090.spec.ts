...
test('test', async ({ page }) => {
  ...
  await page.locator('#password_container div').filter({ hasText: 'Incorrect password. Please try again. Forgot Password? Forgot Password? Sign in' }).locator('span').first().click();
  await page.getByRole('textbox', { name: 'Enter password' }).click();
  await page.getByRole('textbox', { name: 'Enter password' }).press('ArrowLeft');
  await page.getByRole('textbox', { name: 'Enter password' }).press('ArrowLeft');
  await page.getByRole('textbox', { name: 'Enter password' }).press('ArrowLeft');
  await page.getByRole('textbox', { name: 'Enter password' }).press('ArrowLeft');
  await page.getByRole('textbox', { name: 'Enter password' }).press('ArrowLeft');
