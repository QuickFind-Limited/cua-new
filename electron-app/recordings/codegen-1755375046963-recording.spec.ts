...
test('recorded flow - codegen-1755375046963', async ({ page }) => {
  ...
  // To view the trace: npx playwright show-trace codegen-1755375046963-trace.zip
 ...
 * Generated on: 2025-08-16T20:11:22.564Z
 * Session ID: codegen-1755375046963
 * Start URL: https://www.google.com/
 * End URL: https://inventory.zoho.com/app/893870319#/home/gettingstarted
 * Duration: 36s
 * 
 * To replay this test:
 * npx playwright test codegen-1755375046963-recording.spec.ts
 * 
 * To view the trace:
 * npx playwright show-trace recordings/codegen-1755375046963-trace.zip
 * 
