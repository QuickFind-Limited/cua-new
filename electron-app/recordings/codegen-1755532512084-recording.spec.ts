...
test('recorded flow - codegen-1755532512084', async ({ page }) => {
  ...
  // To view the trace: npx playwright show-trace codegen-1755532512084-trace.zip
 ...
 * Generated on: 2025-08-18T15:55:18.837Z
 * Session ID: codegen-1755532512084
 * Start URL: https://www.google.com/
 * End URL: https://www.google.com/
 * Duration: 7s
 * 
 * To replay this test:
 * npx playwright test codegen-1755532512084-recording.spec.ts
 * 
 * To view the trace:
 * npx playwright show-trace recordings/codegen-1755532512084-trace.zip
 * 
